...
## Conclusion
  ...
  - ### 5.  최종결론
    - 정확도가 원했던 만큼 나오진 않아 아쉬웠지만 비트코인과 같이 변동성이 큰 종목의 경우 급 상승/하락의 추세만 잘 타더라도 손실은 줄이고 이윤을 남길 수 있음을 알게됨. 결국 중요한 건 일별 추세를 따라가는 것 보다 큰 상승/하락 폭을 띄는 추세를 얼만큼 잘 예측할 수 있느냐가 실 투자에 있어 더 도움이 됨.
